...
from my_robot_interfaces.msg import LedPanelArray
...
class LedPannelNode(Node):
    def __init__(self):
        super().__init__("led_pannel")
        self.declare_parameter("led_states",[0,0,0])

        self.led_states_ =self.get_parameter("led_states").value
        self.led_states_publisher_= self.create_publisher(LedPanelArray,"led_states",10)
        ...
        self.get_logger().info("Led Pannel has been started")
