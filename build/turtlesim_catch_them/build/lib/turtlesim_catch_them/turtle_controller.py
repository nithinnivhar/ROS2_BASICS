...
class TurtleControllerNode(Node):
     def __init__(self):
        ...
        self.pose_subcriber_=self.create_subscription(Pose,"turtle1/pose",self.callback_turtle_pose,10)
        self.alive_turtles_subcriber_ = self.create_subscription(TurtleArray, "alive_turtles", self.callback_alive_turtles, 10)
