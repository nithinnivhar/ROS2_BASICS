...
my_robot_interfaces__msg__LedPanelArray__init(my_robot_interfaces__msg__LedPanelArray * msg)
{
  ...
  if (!rosidl_runtime_c__int64__Sequence__init(&msg->led_states, 0)) {
    my_robot_interfaces__msg__LedPanelArray__fini(msg);
    return false;
  }
  return true;
}
...
my_robot_interfaces__msg__LedPanelArray__create()
{
  ...
  my_robot_interfaces__msg__LedPanelArray * msg = (my_robot_interfaces__msg__LedPanelArray *)allocator.allocate(sizeof(my_robot_interfaces__msg__LedPanelArray), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_robot_interfaces__msg__LedPanelArray));
  bool success = my_robot_interfaces__msg__LedPanelArray__init(msg);
  if (!success) {
...
my_robot_interfaces__msg__LedPanelArray__Sequence__init(my_robot_interfaces__msg__LedPanelArray__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_robot_interfaces__msg__LedPanelArray * data = NULL;

  if (size) {
    data = (my_robot_interfaces__msg__LedPanelArray *)allocator.zero_allocate(size, sizeof(my_robot_interfaces__msg__LedPanelArray), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_robot_interfaces__msg__LedPanelArray__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        my_robot_interfaces__msg__LedPanelArray__fini(&data[i - 1]);
      }
...
my_robot_interfaces__msg__LedPanelArray__Sequence__fini(my_robot_interfaces__msg__LedPanelArray__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      my_robot_interfaces__msg__LedPanelArray__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_robot_interfaces__msg__LedPanelArray__Sequence * array = (my_robot_interfaces__msg__LedPanelArray__Sequence *)allocator.allocate(sizeof(my_robot_interfaces__msg__LedPanelArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_robot_interfaces__msg__LedPanelArray__Sequence__init(array, size);
  if (!success) {
...
my_robot_interfaces__msg__LedPanelArray__Sequence__destroy(my_robot_interfaces__msg__LedPanelArray__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_robot_interfaces__msg__LedPanelArray__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_robot_interfaces__msg__LedPanelArray__Sequence__are_equal(const my_robot_interfaces__msg__LedPanelArray__Sequence * lhs, const my_robot_interfaces__msg__LedPanelArray__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_robot_interfaces__msg__LedPanelArray__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_robot_interfaces__msg__LedPanelArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_robot_interfaces__msg__LedPanelArray);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_robot_interfaces__msg__LedPanelArray * data =
      (my_robot_interfaces__msg__LedPanelArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_robot_interfaces__msg__LedPanelArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_robot_interfaces__msg__LedPanelArray__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_robot_interfaces__msg__LedPanelArray__copy(
