...
class Init_ComputerRectangleArea_Response_arear
{
public:
  Init_ComputerRectangleArea_Response_arear()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::my_robot_interfaces::srv::ComputerRectangleArea_Response arear(::my_robot_interfaces::srv::ComputerRectangleArea_Response::_arear_type arg)
  {
    msg_.arear = std::move(arg);
    return std::move(msg_);
  }
...
{
  return my_robot_interfaces::srv::builder::Init_ComputerRectangleArea_Response_arear();
}
